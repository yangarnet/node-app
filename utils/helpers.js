...
const helpers = {
    ...
    hash: rawPassword => {
        if (typeof(rawPassword) === 'string' && rawPassword.length >0) {
            ...
            // create sha256 has
            const hash = crypto.createHmac('sha256', config.hashingSecret).update(rawPassword).digest('hex');
            return hash;
        } else {
            return false;
        }
    ...
    isEmpty: obj => {
        return obj === undefined || (typeof obj === 'string' && obj.length === 0)
        || (typeof obj === 'object' && Object.keys(obj).length === 0)
        || (Array.isArray(obj) && Array.length === 0) || obj === null;
    }
